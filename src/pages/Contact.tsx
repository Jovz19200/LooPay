...
function useFormSubmit() {
  ...
  return { submitted, loading, handleSubmit, reset: () => setSubmitted(false) };
}
  ...
  return (
    <div className="contact-form fade-up">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group"><label>Message *</label><textarea required placeholder="Tell us about yourself and how you'd like to connect..." /></div>
  ...
  if (submitted) {
    return (
      <div className="success-message">
        ...
        <p>We'll send the pitch deck and financials within 24 hours.</p>
      </div>
    );
  }
  return (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <select>
            ...
            <option>Seed</option>
            <option>Grant / Accelerator</option>
            <option>Strategic Partnership</option>
          </select>
        </div>
        <div className="form-group"><label>What would you like to know?</label><textarea placeholder="Questions about the business model, market size, team, pitch deck..." /></div>
        <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', padding: 14 }}>
  ...
  if (submitted) {
    return (
      <div className="success-message">
        ...
        <p>We will contact you within 48 hours to schedule a visit.</p>
      </div>
    );
  }
  return (
...
function CoFounderForm() {
  ...
  if (submitted) {
    return (
      <div className="success-message">
        <h3>✓ Application received!</h3>
        <p>We'll schedule a call within 48 hours.</p>
      </div>
    );
  }
  return (
  ...
  return (
    <>
      <PageHero
        ...
        sub="Whether you're an investor, a school, a co-founder, or a researcher — we want to hear from you."
      />
        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-info">
              ...
              <div className="ci-card fade-up">
                <div className="ci-icon" style={{ background: 'var(--green-l)' }}>📍</div>
                <div>
                  <h4>Location</h4>
                  <p>Kigali, Rwanda</p>
              ...
              <div className="ci-card fade-up">
                <div className="ci-icon" style={{ background: 'var(--orange-l)' }}>🎓</div>
                <div>
              ...
              <div style={{ marginTop: 8 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <RichCard
                    ...
                    title="💼 Investors"
                    body="Pre-seed stage. Seeking $50K to build and deploy a pilot at 3 schools. Full pitch deck and financial model available."
                    style={{ padding: '18px 18px 18px 24px' }}
                  />
                  <RichCard
                    accentColor="var(--purple)"
                    title="🤝 Co-Founders"
                    body="We are looking for a technical co-founder and an operations lead. If you understand African fintech or school operations, let's talk."
                    style={{ padding: '18px 18px 18px 24px' }}
                  />
                  <RichCard
            ...
            <div>
              <div className="audience-tabs">
                {tabs.map(({ id, label }) => (
                  <button
                    key={id}
                    className={`atab${active === id ? ' active' : ''}`}
